 ...
 * Generated at: 2019-09-06 14:39:35 UTC
...
public final class loginAction_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 request.setCharacterEncoding("UTF-8"); 
      ...
      out.write("<title>JSP ê²ìí ì¹ ì¬ì´í¸</title>\n");
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("   ");
      ...
      if(userID != null){
         ...
         script.println("alert('ì´ë¯¸ ë¡ê·¸ì¸ì´ ëì´ììµëë¤.')");
      ...
      if(result == 1){
         ...
         PrintWriter script = response.getWriter();
         script.println("<script>");
         script.println("alert('ë¹ë°ë²í¸ê° íë¦½ëë¤.')");
         script.println("history.back()");
         script.println("</script>");
      }else if(result == -1){
         PrintWriter script = response.getWriter();
         script.println("<script>");
         script.println("alert('ì¡´ì¬íì§ ìë ìì´ëìëë¤.')");
         script.println("history.back()");
         script.println("</script>");
      }else if(result == -2){
         PrintWriter script = response.getWriter();
         script.println("<script>");
         script.println("alert('ë°ì´í°ë² ì´ì¤ ì¤ë¥ê° ë°ìíìµëë¤.')");
         script.println("history.back()");
         script.println("</script>");
      }
